...
class ControllerExtensionModuleContactus extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('module_contactus', $this->request->post);
		...
		if (isset($this->request->post['module_contactus_status'])) {
			$data['module_contactus_status'] = $this->request->post['module_contactus_status'];
		} else {
			$data['module_contactus_status'] = $this->config->get('module_contactus_status');
		}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/contactus')) {
